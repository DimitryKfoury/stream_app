...
with out_col:
     ...
     axs[0,0].set_title(inp +'Distribution de'+inp1+'pour les crédits acceptés')
     axs[1,0].set_title(inp +'Distribution de'+inp1+'pour les crédits refusés')
     axs[0,1].set_title(inp +'Distribution de'+inp2+'pour les crédits acceptés')
     axs[1,1].set_title(inp +'Distribution de'+inp2+'pour les crédits refusés')
